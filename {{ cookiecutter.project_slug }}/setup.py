...
setup(
    ...
    url='{{ cookiecutter.project_url }}',  # Optional
    ...
    # larger catalog.
    keywords='{{ cookiecutter.project_keywords }}',  # Optional
    ...
    project_urls={  # Optional
        'Bug Reports': 'https://github.com/genosltd/{{ cookiecutter.project_slug }}/issues',
        'Source': 'https://github.com/genosltd/{{ cookiecutter.project_slug }}/',
    },
)
